...
def _process_major(major):
    ...
    relative_majors = [m.strip() for m in major.get("facilName", "").split(",") if m.strip()]
    ...
    return {
        ...
        "relate_depts": relative_majors, # 관련 학과(유사학과)
...
def main():
    ...
    with open("./data/json/careernet.json", "w", encoding="utf-8") as f:
